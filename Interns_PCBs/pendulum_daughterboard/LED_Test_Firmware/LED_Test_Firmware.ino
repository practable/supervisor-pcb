...
void setup() {
  ...
  pinMode (STU_LED_1, INPUT);
  pinMode (STU_LED_2, INPUT);
  pinMode (STU_LED_3, INPUT);
  pinMode (SUP_LED_1, INPUT);
  pinMode (SUP_LED_2, INPUT);
  pinMode (SUP_LED_3, INPUT);
  pinMode (STU_ENABLE, INPUT);
  pinMode (DRIVE_IN, INPUT);
  pinMode (LOAD_IN, INPUT);

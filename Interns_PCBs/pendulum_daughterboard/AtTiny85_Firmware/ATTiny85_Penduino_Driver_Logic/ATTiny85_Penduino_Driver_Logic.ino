...
void loop() {
  ...
  else if (oldLoadIn == 1 && oldDriveIn == 1)
  {
  ...
  //  {
  else if (newDriveIn == LOW && newLoadIn == HIGH)
  {
    digitalWrite(driveOutput, HIGH);
    digitalWrite(loadOutput, HIGH);
  }
  else if (newDriveIn == HIGH && newLoadIn == LOW)
  {
    digitalWrite(driveOutput, LOW);
    digitalWrite(loadOutput, LOW);
  }
  else if (newLoadIn == 0 && newDriveIn == 0)
  {
    digitalWrite(driveOutput, HIGH);
    digitalWrite(loadOutput, LOW);
    digitalWrite(LED, LOW);
